...
export const ModalProvider = ({ children }) => {
  ...
  return (
    <ModalContext.Provider value={{ showConfirm, showAlert }}>
      {children}
      {modal.isOpen && (
        <div className={`Modal_overlay ${theme === 'dark' ? 'Modal_Dark' : 'Modal_Light'}`} onClick={modal.isAlert ? modal.onConfirm : modal.onCancel}>
          <div 
            className={`Modal_container Modal_type-${modal.type} ${theme === 'dark' ? 'Modal_ContainerDark' : ''}`} 
