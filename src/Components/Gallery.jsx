...
import { 
  ...
  FiDownload, FiEye, FiX, FiCode, FiLoader, FiTerminal, FiXCircle
} from 'react-icons/fi';
...
const renderPreviewModal = () => {
      ...
      <div className="Gallery_modalContent" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="Gallery_modalFooter">
          <div className="Gallery_codeIndicator">
            ...
            {!isBlocked && <span className="badge">CSS</span>}
        ...
        >
          ...
          <div className="Gallery_cardScaler">
            ...
            <div className="Gallery_cardPreviewArea">
              {isFuture ? (
                ...
                upload.visibility === false ? (
                  <div className="Gallery_statusIcon blocked" onClick={() => setPreviewData(upload)} style={{ cursor: 'pointer' }}>
                    <FiX /> <p>Admin Blocked</p>
                  </div>
                ) : (
            ...
            <div className="Gallery_cardFooter">
              ...
              {upload && upload.visibility !== false && (
              ...
              {upload && upload.visibility === false && (
                <div className="Gallery_blockedNote">Contact Support</div>
              )}
            </div>
  ...
  return (
    <div className={`Gallery_container Gallery_fadePage ${theme === 'dark' ? 'GAL_dark' : 'GAL_light'}`}>
      {renderPreviewModal()}
